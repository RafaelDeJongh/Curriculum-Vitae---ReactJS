...
var eContent = [{
	...
	cBoxMain: [{
		...
		description: "WordPress WooCommerce Webshop for a B2B company.",
		yearStart: "",
		yearEnd: "2017"
	}, {
		id: 3,
		...
		id: 4,
		work: "DDCare.be",
		description: "WordPress website for a Belgian dentist.",
		yearStart: "",
		yearEnd: "2017"
	}, {
		id: 5,
		work: "Beeple.eu",
		description: "WordPress website for a startup company as an internship assingment.",
		yearStart: "",
		yearEnd: "2017"
	}, {
		id: 6,
		...
		id: 7,
		work: "Safegold.ca",
		description: "WordPress website for a physical store in Canada.",
		yearStart: "",
		yearEnd: "2017"
	}, {
		id: 8,
		work: "Ninavanrompaey.be",
		description: "Reacreation of a HTML5 & CSS3 website in WordPress.",
		yearStart: "",
		yearEnd: "2017"
	}, {
		id: 9,
		...
		description: "WordPress website with a focus on galleries.",
		yearStart: "",
		yearEnd: "2016"
	}, {
		id: 12,
		...
		description: "WordPress website with specifc requirements.",
		yearStart: "",
		yearEnd: "2015"
	}, {
		id: 15,
		work: "Steam Workshop Paid Mods: Gifts of Akatosh",
		description: "A personal ollaboration with Valve and Bethesda to create mods for Skyrim.",
		yearStart: "",
		yearEnd: "2015"
	}, {
		id: 16,
		work: "Machinefloor.com",
		description: "Head of 3D Art, Moderator.",
		yearStart: "2013",
		yearEnd: "Present"
	}],
	cBoxFooter: [{
		cListLT: "Web Development",
		cListL: [{ id: 1, item: "HTML5" }, { id: 2, item: "CSS3" }, { id: 3, item: "Sass/Less" }, { id: 4, item: "JavaScript" }, { id: 5, item: "jQuery" }, { id: 6, item: "ExpressJS" }, { id: 7, item: "NodeJS" }, { id: 8, item: "VueJS" }, { id: 9, item: "PHP" }, { id: 10, item: "MySQL" }, { id: 11, item: "WordPress" }, { id: 12, item: "WooCommerce" }, { id: 13, item: "SEO/SMO/SME" }, { id: 14, item: "Security Optimisation" }, { id: 15, item: "Server Configuration" }],
		cListRT: "Software",
		cListR: [{ id: 1, item: "Notepad++" }, { id: 2, item: "Photoshop" }, { id: 3, item: "Illustrator" }, { id: 4, item: "DreamWeaver" }, { id: 5, item: "Premiere Pro" }, { id: 6, item: "After Effects" }, { id: 7, item: "InDesign" }, { id: 8, item: "Audition" }, { id: 9, item: "3DsMax" }, { id: 10, item: "Quixel Suite" }, { id: 11, item: "Marmoset Toolbag" }, { id: 12, item: "Microsoft Office" }]
	}]
}];
